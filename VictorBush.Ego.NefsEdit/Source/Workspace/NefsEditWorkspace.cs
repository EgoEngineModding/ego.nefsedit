...
namespace VictorBush.Ego.NefsEdit.Workspace
{
	...
	internal class NefsEditWorkspace : INefsEditWorkspace
	{
		...
		/// </summary>
		/// <remarks>
		/// The purpose for this function is to provide a list of all files that will be extracted. This allows the
		/// progress reporting to be accurate (allows knowing the total number of items to be extracted before starting).
		/// </remarks>
