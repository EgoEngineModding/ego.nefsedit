namespace VictorBush.Ego.NefsEdit.UI
{
    partial class EditorForm
    {
		...
		private void InitializeComponent()
		{
			...
			this.mainMenuStrip.Items.AddRange(new ToolStripItem[] { this.fileMainMenuItem, this.editToolStripMenuItem, this.itemMainMenuItem, this.viewMainMenuItem, this.toolsMainMenuItem, this.helpMainMenuItem, this.discordToolStripMenuItem });
