...
namespace VictorBush.Ego.NefsEdit.Tests
{
    ...
    internal class TestHelpers
    {
        ...
        internal static NefsArchive CreateTestArchive(string filePath)
        {
            ...
            var file1 = new NefsItem(new NefsItemId(0), "file1", new NefsItemId(0), NefsItemType.File, file1DataSource, transform, CreateUnknownData());
            items.Add(file1);

            var dir1DataSource = new NefsEmptyDataSource();
            var dir1 = new NefsItem(new NefsItemId(1), "dir1", new NefsItemId(1), NefsItemType.Directory, dir1DataSource, null, CreateUnknownData());
            items.Add(dir1);
            ...
            var file2 = new NefsItem(new NefsItemId(2), "file2", dir1.Id, NefsItemType.File, file2DataSource, transform, CreateUnknownData());
            items.Add(file2);
