...
internal class TestHelpers
{
	...
	internal static NefsArchive CreateTestArchive(string filePath)
	{
		...
		var volumeSource = new NefsVolumeSource(filePath, 0, 0);
		...
		var file1DataSource = new NefsVolumeDataSource(volumeSource, 100, new NefsItemSize(20, file1Chunks));
		...
		var file2DataSource = new NefsVolumeDataSource(volumeSource, 104, new NefsItemSize(15, file2Chunks));
