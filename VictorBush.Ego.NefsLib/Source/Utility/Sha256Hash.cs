...
namespace VictorBush.Ego.NefsLib.Source.Utility
{
    ...
    public struct Sha256Hash
    {
        ...
        /// <inheritdoc/>
        public override bool Equals(object obj) => obj is Sha256Hash hash && this.Value.SequenceEqual(hash.Value);

        /// <inheritdoc/>
        public override int GetHashCode() => this.Value.GetHashCode();

        /// <inheritdoc/>
        public override string ToString() => string.Join("", this.Value.Select(b => $"{b:X}"));
    }
}
