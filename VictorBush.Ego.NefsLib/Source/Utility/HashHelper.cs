...
namespace VictorBush.Ego.NefsLib.Utility
{
    ...
    internal static class HashHelper
    {
        ...
        /// The offset to the beginning of the primary header data. This contains the intro, toc,
        /// parts 1-5, and part 8.
        /// </param>
        /// <param name="primarySize">The size of primary header data block.</param>
        /// <param name="secondaryOffset">
        /// The offset to the beginning of the secondary header data. This contains parts 6 and 7.
        /// This is different from the secondary base offset (although their values may be the same).
        /// </param>
