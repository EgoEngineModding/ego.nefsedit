...
public sealed class Nefs150HeaderPart4 : INefsHeaderPart4
{
	...
	private readonly List<Nefs150HeaderPart4Entry> entriesByIndex;
	private readonly Dictionary<Guid, uint> indexLookup;

	/// <summary>
	/// Initializes a new instance of the <see cref="Nefs150HeaderPart4"/> class.
	/// </summary>
	...
	internal Nefs150HeaderPart4(IEnumerable<Nefs150HeaderPart4Entry> entries, Dictionary<Guid, uint> indexLookup, uint unkownEndValue)
	{
		this.entriesByIndex = new List<Nefs150HeaderPart4Entry>(entries);
	...
	{
		this.entriesByIndex = new List<Nefs150HeaderPart4Entry>();
	...
	/// </summary>
	public IReadOnlyList<Nefs150HeaderPart4Entry> EntriesByIndex => this.entriesByIndex;
