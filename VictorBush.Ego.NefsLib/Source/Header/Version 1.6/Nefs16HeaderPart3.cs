...
namespace VictorBush.Ego.NefsLib.Header
{
    ...
    /// Header part 3.
    /// </summary>
    public class Nefs16HeaderPart3
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Nefs16HeaderPart3"/> class.
        /// </summary>
        /// <param name="entries">A unique list of strings.</param>
        internal Nefs16HeaderPart3(IEnumerable<string> entries)
        {
            this.Init(entries);
        }
        ...
        internal Nefs16HeaderPart3(NefsItemList items)
        {
