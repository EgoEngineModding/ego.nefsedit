...
/// </summary>
public sealed class Nefs16Header : INefsHeader
{
	/// <summary>
	...
	public NefsItem CreateItemInfo(Guid guid, NefsItemList dataSourceList)
	{
		...
		var transform = new NefsDataTransform(TableOfContents.BlockSize, attributes.V20IsZlib, Intro.IsEncrypted ? Intro.GetAesKey() : null);
		...
		else
		{
			...
			var chunkSize = TableOfContents.BlockSize;
