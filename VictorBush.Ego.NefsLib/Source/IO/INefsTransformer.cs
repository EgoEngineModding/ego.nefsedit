...
namespace VictorBush.Ego.NefsLib.IO
{
    ...
    public interface INefsTransformer
    {
        ...
        /// The absolute offset from the beginning of the input stream to detransform.
        /// </param>
        ...
        /// <param name="inputOffset">
        /// The absolute offset from the beginning of the input file to detransform.
        /// </param>
        ...
        /// <param name="inputOffset">
        /// The absolute offset from the beginning of the input stream to transform.
        /// </param>
        ...
        Task<UInt32> TransformChunkAsync(
            Stream input,
        ...
        /// <summary>
        /// Transforms an input data source to a specified output file. The transform used is
        ...
        /// <param name="inputFile">The path to the input file.</param>
        /// <param name="inputOffset">
        /// The absolute offset from the beginning of the input file to transform.
        /// </param>
        /// <param name="inputLength">The number of bytes to transform.</param>
        /// <param name="output">The output stream to write to.</param>
        /// <param name="outputOffset">
