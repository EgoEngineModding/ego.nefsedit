...
/// <summary>
/// Identifies the modification state of an item in an archive. When an item is modified, the action does not take
/// effect until the archive is saved. In the mean time, the modification state identifies the pending change.
/// </summary>
