    ...
    internal class TestArchiveNotModified
    {
        ...
        */
        ...
        public static NefsArchive Create(string filePath)
        {
            ...
            var file3 = new NefsItem(new NefsItemId(File3ItemId), File3Name, new NefsItemId(File3DirectoryId), NefsItemType.File, file3DataSource, file3Transform, TestHelpers.CreateUnknownData());
            items.Add(file3);
