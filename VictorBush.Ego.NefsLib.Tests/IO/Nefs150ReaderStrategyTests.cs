...
public class Nefs150ReaderStrategyTests
{
	...
	public async Task Read150HeaderPart1Async_ExtraBytesAtEnd_ExtraBytesIgnored()
	{
		...
		var size = Nefs150TocEntry.ByteCount + 2;
		var offset = 5;

		// Test
		var part1 = await Nefs150ReaderStrategy.Read150HeaderPart1Async(br, offset, size, this.p);
	...
	public async Task ReadHeaderPart5Async_ValidData_DataRead()
	{
		...
		// Test
		var part5 = await Nefs150ReaderStrategy.ReadHeaderPart5Async(endianReader, offset, size, this.p);
