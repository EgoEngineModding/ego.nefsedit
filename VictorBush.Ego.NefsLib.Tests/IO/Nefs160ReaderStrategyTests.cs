...
public class Nefs160ReaderStrategyTests
{
	...
	public async Task ReadHeaderPart1Async_ExtraBytesAtEnd_ExtraBytesIgnored()
	{
		...
		var size = Nefs160TocEntry.ByteCount + 2;
		var offset = 5;

		// Test
		var part1 = await Nefs160ReaderStrategy.ReadHeaderPart1Async(br, offset, size, this.p);
	...
	public async Task ReadHeaderPart1Async_OffsetOutOfBounds_NoEntries()
	{
		...
		// Test
		var part1 = await Nefs160ReaderStrategy.ReadHeaderPart1Async(br, 10, 5, this.p);
	...
	public async Task ReadHeaderPart1Async_SizeOutOfBounds_NoEntries()
	{
		...
		// Test
		var part1 = await Nefs160ReaderStrategy.ReadHeaderPart1Async(br, 0, 20, this.p);
	...
	public async Task ReadHeaderPart1Async_ValidData_DataRead()
	{
		...
		var stream = new MemoryStream(bytes);
		using var br = new EndianBinaryReader(stream, true);
		var size = 2 * Nefs160TocEntry.ByteCount;
		var offset = 5;
	...
	public async Task ReadHeaderPart1Async_ZeroSize_NoEntries()
	{
		...
		// Test
		var part1 = await Nefs160ReaderStrategy.ReadHeaderPart1Async(br, 0, 0, this.p);
	...
	public async Task ReadHeaderPart2Async_ExtraBytesAtEnd_ExtraBytesIgnored()
	{
		...
		var stream = new MemoryStream(bytes);
		using var br = new EndianBinaryReader(stream, true);
		var size = Nefs160TocSharedEntryInfo.ByteCount + 2;
		var offset = 5;

		// Test
		var part2 = await Nefs160ReaderStrategy.ReadHeaderPart2Async(br, offset, size, this.p);
	...
	public async Task ReadHeaderPart2Async_ValidData_DataRead()
	{
		...
		var stream = new MemoryStream(bytes);
		using var br = new EndianBinaryReader(stream, true);
		var size = 2 * Nefs160TocSharedEntryInfo.ByteCount;
		var offset = 5;
	...
	public async Task ReadHeaderPart6Async_ValidData_DataRead()
	{
		...
		var part1Offset = 5;
		var part1Size = 2 * Nefs160TocEntry.ByteCount;
		...
		using (var part1Stream = new MemoryStream(part1Bytes))
		{
			...
			entryTable = await Nefs160ReaderStrategy.ReadHeaderPart1Async(br, part1Offset, part1Size, this.p);
		}
		...
		using (var part6Stream = new MemoryStream(bytes))
		{
			...
			part6 = await Nefs160ReaderStrategy.Read160HeaderPart6Async(br, part6Offset, entryTable.Entries.Count, this.p);
		}
	...
	public async Task ReadHeaderPart7Async_ValidData_DataRead()
	{
		...
		// Test
		var part7 = await Nefs160ReaderStrategy.Read160HeaderPart7Async(br, offset, 2, this.p);
